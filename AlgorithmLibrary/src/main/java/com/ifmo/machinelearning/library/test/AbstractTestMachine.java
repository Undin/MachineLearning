 ...
 */
public abstract class AbstractTestMachine<T extends ClassifiedData> {
    ...
    public AbstractTestMachine(List<T> dataSet) {
        this(dataSet, false);
    }

    public AbstractTestMachine(List<T> dataSet, boolean parallelTest) {
